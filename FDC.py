...
OBSERVED = {
    ...
    'bottom_D10': (4.183, 0.004), 'top_Oh': (172.76, 0.30)
}
...
def get_seed(parent_a=None, parent_b=None):
    ...
    ADAM_CONFIG = {
        ...
        'f_gated_b_s': 1,
        'f_gated_c_u': 5,
        'f_gated_c_u_step1': 11,
        'f_gated_mu_e': 0,
        'f_gated_s_d': 13,
        'f_gated_s_d_step1': 19,
        'f_gated_t_c': 6,
        'f_gated_tau_mu': 10,
        'f_gated_tau_mu_step1': 11,
        'f_gated_tau_mu_step2': 10,
        'f_gated_tau_mu_step3': 9,
        'f_gated_tau_mu_step4': 6,
        'f_lam_a_step1': 19,
        'f_lam_d_step1': 20,
        'f_lam_o_step1': 23,
        'f_lambda_A': 11,
        ...
        'f_log_r_b_s_step2': 3,
        'f_log_r_b_s_step3': 5,
        'f_log_r_b_s_step4': 16,
        'f_log_r_c_u': 4,
        'f_log_r_c_u_step1': 11,
        'f_log_r_c_u_step2': 58,
        'f_log_r_c_u_step3': 5,
        'f_log_r_c_u_step4': 7,
        'f_log_r_c_u_step5': 3,
        'f_log_r_mu_e': 15,
        'f_log_r_mu_e_step1': 11,
        'f_log_r_mu_e_step2': 20,
        'f_log_r_mu_e_step3': 31,
        'f_log_r_mu_e_step4': 21,
        'f_log_r_s_d': 11,
        'f_log_r_s_d_step1': 15,
        'f_log_r_s_d_step2': 21,
        'f_log_r_s_d_step3': 6,
        'f_log_r_s_d_step4': 3,
        'f_log_r_t_c': 14,
        'f_log_r_t_c_step1': 5,
        'f_log_r_t_c_step2': 13,
        'f_log_r_t_c_step3': 17,
        'f_log_r_t_c_step4': 10,
        'f_log_r_t_c_step5': 5,
        'f_log_r_tau_mu': 6,
        'f_log_r_tau_mu_step1': 4,
        'f_log_r_tau_mu_step2': 5,
        'f_log_r_tau_mu_step3': 18,
        'f_log_r_tau_mu_step4': 14,
        'f_log_y1_step1': 3,
        'f_log_y2_step1': 5,
        'f_m_bare_1': 50,
        'f_m_bare_1_step1': 3,
        ...
        'f_m_bare_t_step2': 11,
        'f_m_bare_tau': 8,
        'f_m_bare_tau_step1': 15,
        'f_m_bare_tau_step2': 5,
        'f_m_bare_u': 5,
        'f_m_bare_u_step1': 1,
        'f_m_bare_u_step2': 14,
        'f_r_net_pp_step1': 16,
        ...
        'lam_step3': 20,
        'loop_ALPHA_Z': 2,
        'loop_ALPHA_Z_step1': 5,
        'loop_AMP_D_CORR': 13,
        'loop_AMP_D_CORR_step1': 3,
        'loop_AMP_O_CORR': 5,
        'loop_AMP_O_CORR_step1': 22,
        'loop_R_net_per_pair': 28,
        'loop_dm1_qed': 25,
        'loop_dm2_qcd_d': 13,
        'loop_dm2_qcd_d_step1': 3,
        'loop_dm2_qcd_u': 16,
        'loop_dm2_qcd_u_step1': 27,
        'loop_dm2_qed': 24,
        'loop_factor': 22,
        'loop_factor_step1': 4,
        'loop_factor_step2': 10,
        'loop_m_e_phys_step1': 7,
        'loop_m_e_phys_step2': 10,
        'loop_m_e_phys_step3': 8,
        'loop_m_mu_phys_step1': 13,
        'loop_m_phys_step1': 11,
        'loop_m_ratio_step1': 7,
        'loop_m_ratio_step2': 5,
        'loop_m_tau_phys_step1': 46,
        'loop_r_net_pp_step1': 8,
        'loop_t_mass': 1,
        'loop_t_mass_step1': 22,
        'loop_t_mass_step2': 15,
        'loop_t_mass_step3': 3,
        'm_pl_j_step1': 4,
        'm_pl_kg_step1': 16,
        'm_pl_kg_step2': 41,
        ...
        'ratio_tc_step1': 1,
        'rho_exp_term': 125,
        'rho_exp_term_step1': 7,
        'rho_exp_term_step2': 10,
        'rho_exp_term_step3': 4,
        'rho_exp_term_step4': 6,
        'rho_kappa': 19,
        'rho_kappa_step1': 5,
        'rho_kappa_step2': 36,
        'rho_kappa_step3': 2,
        'rho_kappa_step4': 9,
        'rho_vac_bare': 25,
        'rho_vac_bare_step1': 3,
        'rho_vac_bare_step2': 3,
        's_step1': 12,
        'sin2_R1': 15,
        'sin2_R2': 29,
        'sin2_bare': 12,
    ...
    ALL_POSSIBLE_LEVERS = [
        ...
        'loop_dm1_qed',
        'loop_dm2_qcd_d', 'loop_dm2_qcd_d_step1', 'loop_dm2_qcd_u',
        'loop_dm2_qcd_u_step1', 'loop_dm2_qed', 'loop_factor',
    ...
    DEFAULT_GENE_VALUE = 1023  # Use a default that's inside the old 1024 range
...
def run_simulation(P_in, O, verbose=True):
    ...
    try:
        ...
        # V = 246.2...
        V = round_if_needed(246.2196434459463, P['V'])
    ...
    CORE_KEYS = ['inv_alpha_MZ', 'm_H', 'G', 'sin2_theta_W', 'alpha_s_MZ', 'm_nu', 'theta_C', 'theta_23', 'N_efolds', 'rho_true']
...
class GAManager:
    ...
    def fitness_func(self, ga_instance, solution, solution_idx):
        ...
        1. HARD CONSTRAINT: Must match 25/25 predictions (sigma < 1).
    ...
    def run_manager(self):
        ...
        while epoch_count < self.total_epochs_to_run:
            ...
            if len(self.stable_parents) == 1:
                ...
                pool_size = min(10, len(self.stable_parents))
            ...
            print(f"Initial Parents Mating: 10")
        ...
        print(f"Matches (within 1-sigma): {opt_matches} / 25")
        ...
        if opt_matches < 25:
             print("\n--- ⚠️ WARNING: The best solution found did NOT achieve 25/25 matches. ---")
             print("--- You may need to increase TOTAL_EPOCHS_TO_RUN. ---")

if __name__ == "__main__":
    print("--- 🔬 Starting VFD-4.0 **Minimal Digit Search** ---")
    
    # --- THESE ARE YOUR MAIN SEARCH PARAMETERS ---
    
    # The precision cap (decimal digits)
    FINAL_CAP = 1024
    
    # The total number of epochs to run the search for. (Set to zero for demonstration; change to run optimizer)
    # The GA will try to find a 25/25 solution and then
    # spend the rest of the epochs trying to minimize its digit cost.
    TOTAL_EPOCHS_TO_RUN = 0
     # <-- You can increase this for a deeper search
